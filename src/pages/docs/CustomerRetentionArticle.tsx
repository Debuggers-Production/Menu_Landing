...
export function CustomerRetentionArticle() {
  return (
    <article className="prose-slate max-w-none">
      <Helmet>
        <title>Customer Retention Strategies | MenuKit</title>
        <meta name="description" content="How to turn first-time visitors into loyal regulars." />
      </Helmet>
      <header className="mb-12 border-b border-slate-200 pb-8">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight mb-6">Customer Retention Strategies for Restaurants</h1>
