  ...
  return (
    <article className="prose-slate max-w-none">
      <Helmet>
        ...
        <meta name="description" content="Why top restaurants are adopting QR ordering systems." />
      </Helmet>
      <header className="mb-12 border-b border-slate-200 pb-8">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight mb-6">Benefits of QR Code Menus for Restaurants</h1>
